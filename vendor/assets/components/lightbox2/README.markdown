# Lightbox2 for revealjs

This repository is base on the original lightbox script. It is intended to be
used with [`middleman-presentation`](https://github.com/maxmeyer/middleman-presentation).
